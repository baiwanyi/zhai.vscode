/**
 * Webview 构建配置：React 19 + Tailwind 4 打包为自包含静态资源，供仪表盘与 AI 对话 Webview 加载。
...
export default defineConfig({
    ...
    build: {
        ...
        rollupOptions: {
            // 多入口：仪表盘（index.html）与 AI 对话（aichat.html）均由 Vite 构建
            input: {
                index: resolve(import.meta.dirname, 'src/webview/index.html'),
                aichat: resolve(import.meta.dirname, 'src/webview/aichat.html'),
            },
        },
    },
})
